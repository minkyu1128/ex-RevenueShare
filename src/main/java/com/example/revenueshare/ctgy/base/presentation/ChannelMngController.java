...
import com.example.revenueshare.ctgy.base.service.ChannelMngService;
...
public class ChannelMngController {
    ...
    @GetMapping(value = "/base/channel", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/base/channel/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/base/channel", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/base/channel", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = "/base/channel", produces = MediaType.APPLICATION_JSON_VALUE)
