...
import com.example.revenueshare.ctgy.base.service.CmpnyMngService;
...
public class CmpnyMngController {
    ...
    @GetMapping(value = "/base/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/base/cmpny/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/base/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/base/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
