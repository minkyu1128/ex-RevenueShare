...
import com.example.revenueshare.ctgy.cntrt.service.ContractCmpnyMngService;
...
public class ContractCmpnyMngController {
    ...
    @GetMapping(value = "/cntrt/ch/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/cntrt/ch/cmpny/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/cntrt/ch/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/cntrt/ch/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
