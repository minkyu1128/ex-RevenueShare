package com.example.revenueshare.ctgy.cntrt.presentation;


import com.example.revenueshare.core.exception.RsException;
import com.example.revenueshare.core.model.ResponseVO;
import com.example.revenueshare.ctgy.cntrt.model.ContractCreatorDTO;
import com.example.revenueshare.ctgy.cntrt.model.ContractCreatorSearchDTO;
import com.example.revenueshare.ctgy.cntrt.service.ContractCreatorMngService;
...
public class ContractCreatorMngController {
    ...
    @GetMapping(value = "/cntrt/ch/creator", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/cntrt/ch/creator/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/cntrt/ch/creator", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/cntrt/ch/creator", produces = MediaType.APPLICATION_JSON_VALUE)
