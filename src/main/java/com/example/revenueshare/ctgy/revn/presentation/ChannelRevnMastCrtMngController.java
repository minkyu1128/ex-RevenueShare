package com.example.revenueshare.ctgy.revn.presentation;
...
import com.example.revenueshare.ctgy.revn.service.ChannelRevnMastCrtMngService;
...
public class ChannelRevnMastCrtMngController {
    ...
    @GetMapping(value = "/revn/ch/creator", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/revn/ch/creator/{contractCreator}/{calYm}", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity findById(@PathVariable String contractCreator, @PathVariable String calYm) {
    ...
    @PostMapping(value = "/revn/ch/creator", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/revn/ch/creator", produces = MediaType.APPLICATION_JSON_VALUE)
