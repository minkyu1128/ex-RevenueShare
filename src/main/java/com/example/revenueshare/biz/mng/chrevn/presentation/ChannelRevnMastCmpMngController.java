...
public class ChannelRevnMastCmpMngController {
    ...
    @GetMapping(value = "/mng/ch/revn/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/mng/ch/revn/cmpny/{cntrCmpId}/{calYm}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/mng/ch/revn/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/mng/ch/revn/cmpny", produces = MediaType.APPLICATION_JSON_VALUE)
