...
import com.example.revenueshare.biz.mng.chrevn.service.ChannelRsMastMngService;
...
public class ChannelRsMastMngController {
    ...
    @GetMapping(value = "/mng/ch/revn/rs", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/mng/ch/revn/rs/{channelId}/{calYm}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/mng/ch/revn/rs", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = "/mng/ch/revn/rs", produces = MediaType.APPLICATION_JSON_VALUE)
